...
namespace StichtingAccessibility.Server.Migrations
{
    ...
    [Migration("20240125050612_InviteEditedEmailName2")]
    partial class InviteEditedEmailName2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StichtingAccessibility.Server.Models.Invite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BedrijfsMedewerkerId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("BedrijfsMedewerkerId");
            ...
            modelBuilder.Entity("StichtingAccessibility.Server.Models.Beheerder", b =>
                {
                    b.HasBaseType("StichtingAccessibility.Server.Models.BedrijfsMedewerker");
            ...
            modelBuilder.Entity("StichtingAccessibility.Server.Models.Invite", b =>
                {
                    b.HasOne("StichtingAccessibility.Server.Models.BedrijfsMedewerker", null)
                        .WithMany("Invites")
                        .HasForeignKey("BedrijfsMedewerkerId");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Ontvanger")
                        .WithMany()
                        .HasForeignKey("OntvangerId");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Uitgever")
                        .WithMany()
